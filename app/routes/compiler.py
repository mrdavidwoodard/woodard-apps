...
STRUCTURED_FIELD_SETS = {
    ...
    "w2": [
        ...
        ("wages_box_1", "Wages Box 1"),
        ("federal_withholding_box_2", "Federal Withholding Box 2"),
        ("social_security_wages_box_3", "Social Security Wages Box 3"),
        ("social_security_tax_box_4", "Social Security Tax Box 4"),
        ("medicare_wages_box_5", "Medicare Wages Box 5"),
        ("medicare_tax_box_6", "Medicare Tax Box 6"),
        ("state_wages_box_16", "State Wages Box 16"),
        ("state_tax_box_17", "State Tax Box 17"),
    ],
    "1099_int": [
        ("payer_name", "Payer Name"),
        ("interest_income_box_1", "Interest Income Box 1"),
        ("early_withdrawal_penalty_box_2", "Early Withdrawal Penalty Box 2"),
        ("us_savings_bonds_box_3", "U.S. Savings Bonds Box 3"),
        ("federal_withholding_box_4", "Federal Withholding Box 4"),
        ("tax_exempt_interest_box_8", "Tax-Exempt Interest Box 8"),
    ],
    "1099_div": [
        ("payer_name", "Payer Name"),
        ("ordinary_dividends_box_1a", "Ordinary Dividends Box 1a"),
        ("qualified_dividends_box_1b", "Qualified Dividends Box 1b"),
        ("capital_gain_distributions_box_2a", "Capital Gain Distributions Box 2a"),
        ("federal_withholding_box_4", "Federal Withholding Box 4"),
    ],
    "1099_b": [
        ("payer_name", "Payer Name"),
        ...
        ("federal_withholding_box_4", "Federal Withholding Box 4"),
        ("short_or_long_term_indicator", "Short / Long Term"),
    ],
    "1098": [
        ("lender_name", "Lender Name"),
        ("mortgage_interest_box_1", "Mortgage Interest Box 1"),
        ("outstanding_mortgage_principal_box_2", "Outstanding Mortgage Principal Box 2"),
        ("points_box_6", "Points Box 6"),
    ],
    "k1": [
