...
class Document(db.Model):
    ...
    detected_document_type = db.Column(db.String(80), nullable=True)
    matching_method = db.Column(db.String(80), nullable=True)
    extracted_text = db.Column(db.Text, nullable=True)
    classification_confidence = db.Column(db.String(50), nullable=True)
    ...
    package_requirements = db.relationship(
        "PackageDocumentRequirement",
        back_populates="document",
        lazy="dynamic",
    )
